...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | RB-007 | Accounts + trail onboarding (multi-user) | P0 | Backlog | XL | TBD |
...
_Nothing in progress._ Top item: **RB-007** (accounts + trail onboarding). Then RB-001 (Venmo), RB-005 (weekly recovery content), RB-006 (two-bucket fund).
