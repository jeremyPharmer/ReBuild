...
| **Elevate** | Email/Gmail, podcast + regular recovery content, **to-do lists**, **five-year journal**, home cameras, workout tracker, favorite recipes, links to **other apps/sites Jeremy creates**; **morning/evening mood & feeling** ritual; **calendar (iCal + work Google)** when asked |
...
| 8 | RB-023 | Calendar: iCal + work Google (ICS) | P1 | Backlog | M | TBD |
...
3. **RB-023 — Calendar (iCal + work Google)** — read-only ICS feeds; today’s agenda on Home; intake 2026-09-01. Detail: [`items/calendar-ical-google.md`](./items/calendar-ical-google.md).
4. **RB-005 — Podcast-first + regular recovery content** — **In Progress**; keep podcast useful + no-repeat; founder still wants some regular recovery content (no duplicate item). Detail: [`items/recovery-content-offers.md`](./items/recovery-content-offers.md).
...
| Next (EA) | RB-002 Gmail → **RB-023 calendar ICS** → RB-005 podcast/recovery → RB-017 cameras → RB-018 workout → RB-019 recipes → RB-015 hub → RB-003 digest | Personal OS cluster; hub needs Jeremy’s app list; calendar is read-only ICS + Home agenda |
