...
- Companion items: [RB-012](./rebrand-jeremyos.md), [RB-014](./todo-lists.md), [RB-016](./five-year-journal-ux.md), [RB-015](./jeremy-apps-hub.md), elevated [RB-002](./email-integration.md) / [RB-005](./recovery-content-offers.md); personal tools [RB-017](./home-cameras-reolink.md), [RB-018](./workout-tracker.md), [RB-019](./favorite-recipes.md); craving cut [RB-020](./drop-craving-stats-home-cta.md); Apple Calendar → Today’s Build [RB-022](./apple-calendar-todays-build.md).
- **2026-08-29 follow-up:** cameras / workout / recipes added — still passes build filter (Jeremy asked).
- **2026-08-31:** Apple Calendar → Today’s Build (RB-022) — founder ask; passes build filter; ranked Next after Now personal-OS cluster.
