...
- **2026-08-29 ship slice:** `/journal` is a five-year day page (year gutter + headline/summary, not stacked feed); evening capture labels → Headline + Short summary with soft 5-sentence hint; existing `one_line` / `journal` storage unchanged.
