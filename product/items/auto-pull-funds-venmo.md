...
- **2026-08-13 stronger 1-tap candidate (RB-007):** **Me-to-me ACH** (Dwolla/Moov): user’s checking → user’s own free HYSA (Ally/etc). ReBuild orchestrates; does not hold funds. May supersede Venmo as the *technical* destination for auto-pull even if Venmo remains a product/UI metaphor — decide after Dwolla eligibility call.
>>>>>>> origin/main
