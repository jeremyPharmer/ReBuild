...
- **2026-08-29 JeremyOS:** rank **8**. Ties elevated email (RB-002) + to-dos (RB-014). Prefer RB-014 list model as source of “open items” when that ships; until then, existing checklist leftovers OK.
